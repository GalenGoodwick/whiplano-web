...
export default function HowItWorksText() {
    return (
        <section className="pt-12 ">
            <div className="bg-white pb-[6rem]">
            ...
            <div className="bg-gradient-to-r from-[#DB2777] to-[#FE658F] text-white pb-[6rem]">
                <div className="container mx-auto flex flex-col gap-[6rem] px-6 bg-">
                    <h1 className="text-5xl font-extrabold pt-[5rem]">The Whiplano Process
                    </h1>
                    {/*1. Creators Publish & Set Rights*/}
                    <div className="flex flex-col ">
                        <h2 className="text-3xl font-extrabold mb-6 ">1. Creators Publish & Set Rights</h2>
                        <p className="text-lg leading-relaxed text-white-700 md:text-justify">
                    ...
                    <div className="flex flex-col ">
                        <h2 className="text-3xl font-extrabold mb-6">2. Holders Activate Artisan Rights</h2>
                        <p className="text-lg leading-relaxed text-white-700 md:text-justify">
                            <ul className="list-disc list-inside pl-[3rem]">
                    ...
                    {/*3. Trading & Growth*/}
                    <div className="flex flex-col ">
                        <h2 className="text-3xl font-extrabold mb-6 ">3. Trading & Growth</h2>
                        <p className="text-lg leading-relaxed text-white-700 md:text-justify">
                            <ul className="list-disc list-inside pl-[3rem]">
            ...
            <div className="container mx-auto flex flex-col gap-[6rem] px-6 ">
                <h1 className="text-5xl pt-[5rem] font-extrabold  text-[#C81E8A]">Seamless Transactions: Fiat & Blockchain Together</h1>
            ...
            <div className="bg-gradient-to-r from-[#DB2777] to-[#FE658F] text-white pb-[6rem]">
                <div className="container mx-auto flex flex-col gap-[6rem] px-6 bg-">
                    <h1 className="text-5xl font-extrabold pt-[5rem] ">Why It Matters</h1>
                    <div className="flex flex-col ">
                        <p className="text-lg leading-relaxed text-white-700 md:text-justify">
                    ...
                    <h1 className="text-5xl font-extrabold mb-10">Join the Movement </h1>
                </div>
            </div>
        </section>
    );
